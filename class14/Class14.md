...
> Q. Q. Complete the code below to filter countData to exclude genes
...
```
    ...
    Info: Working in directory /Users/samfisher/Bimm143_Github/bimm143_github/class14
...
Yes. The same procedure can be repeated using
keggres$less instead of keggres$greater to get the top five
down-regulated pathways. After getting the pathway IDs, they can be
passed to the pathview() function to create the same corresponding
pathway plots as above.
...
Mitotic. The top Reactome pathways match well with our previous KEGG
results. Minor differences may arise due to differences in pathway
databases, gene set definitions, statistical models, and multiple
